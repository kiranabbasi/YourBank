    ...
    return (
        <div className='lg:w-4/5  m-auto my-14'>
            ...
            <img className='absolute top-0 right-0' src={Loginbg} alt="" />
                    <div>
                        <p className='text-4xl text-secondary text-center mb-4'>Login</p>
                        <p className='font-extralight text-base text-zinc-300 text-center'>Welcome back! Please Login to access your account.</p>
                    </div>
